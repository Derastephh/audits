...
\begin{titlepage}
    ...
    \vspace{2cm}
    {\Large\itshape Nwebor Stephen\par}
    \vfill
...
# About Nwebor Stephen

🕵️‍♂️ Smart Contracts Auditor 🧪 Security Researcher

# Disclaimer

I made all effort to find as many vulnerabilities in the code in the given time period, but holds no responsibilities for the findings provided in this document.
