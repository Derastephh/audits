...
\begin{titlepage}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.5\textwidth]{pug.png} 
    \end{figure}
    \vspace*{2cm}
    {\Huge\bfseries PuppyRaffle Protocol Audit Report\par}
    \vspace{1cm}
